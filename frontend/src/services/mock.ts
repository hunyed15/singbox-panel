...
export const updateServer = async (
  ...
  const next: Server = {
    ...
    client_host: payload.clientHost !== undefined ? payload.clientHost : row.client_host,
    ...
    ssh_sudo: payload.sshSudo !== undefined ? (payload.sshSudo ? 1 : 0) : row.ssh_sudo,
  };
